...
5. Use appropriate icons for expand/collapse states`,
    codeExample: `import { Accordion, AccordionItem } from '@your-ui-library/accordion';
        ...
        content: (
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                Simply click on any accordion header to expand or collapse its content. You can have multiple sections, but only one can be open at a time.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              <AccordionTrigger>Is it accessible?</AccordionTrigger>
              <AccordionContent>
                Yes! The accordion component is fully accessible, supporting keyboard navigation and screen readers.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        ),
